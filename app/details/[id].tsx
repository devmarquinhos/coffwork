...
import { ArrowLeft, Heart, Star, Wifi, Plug } from 'lucide-react-native';
...
export default function CoffeeDetails() {
  ...
  const coffeeData = {
    name: 'Cravo Camelia',
    score: '4.9',
    description: 'Um ambiente aconchegante focado em doces artesanais e cafés especiais. Excelente iluminação natural, perfeito para um encontro social ou uma tarde de trabalho tranquilo.',
    ...
    <View style={styles.container}>
      ...
      <View style={styles.topBar}>
        ...
        <TouchableOpacity style={styles.iconButton}>
          <Heart color={COLORS.black} size={24} />
        </TouchableOpacity>
      </View>
        ...
        <View style={styles.sheetContainer}>
          ...
          <View style={styles.headerRow}>
            ...
            <View style={styles.scoreBadge}>
              <Star color={COLORS.mediumBrown} size={18} fill={COLORS.mediumBrown} />
          ...
          <View style={styles.placeholderReview}>
            <Text style={{ color: COLORS.mediumBrown }}>As notas detalhadas entrarão aqui.</Text>
          </View>
